...
The structural contract every corti LLM provider satisfies is the same
:class:`everalgo.llm.LLMClient` Protocol — corti providers must be
...
stable (``corti.component.llm``) even if the everalgo namespace
shifts later.
