...
from corti.infra.ome.config import StrategyOverride, TomlRoot
from corti.infra.ome.decorator import StrategyMeta
from corti.infra.ome.gates import Counter
from corti.infra.ome.triggers import Cron, Idle, Trigger
    ...
    def start(self) -> None:
        ...
        if not self._path.exists():
            raise FileNotFoundError(
                ...
                "Run `corti init` to create configuration files."
            )
