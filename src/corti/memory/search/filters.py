"""Filters DSL → Postgres ``where`` string compiler.
...
from corti.core.errors import FilterError as FilterError
...
def compile_filters(
    ...
    *,
    ...
    """Compile a request's filters into a single Postgres ``where`` string.
