...
Mirrors :mod:`cortistrate.service._session_lock` (and
:class:`cortistrate.core.persistence.markdown.writer.MarkdownWriter`'s
...
Cross-process safety is out of scope: cortistrate is single-process by
