...
preview) plus cortistrate engineering metadata (``owner_id`` / ``owner_type``
...
from cortistrate.component.utils.datetime import UtcDatetime
from cortistrate.core.persistence.sqlite import BaseTable, Field
from cortistrate.core.persistence.sqlite.base import UtcDateTimeColumn
