"""OpenAI-compatible LLM provider for corti.
...
``OpenAICompatClient`` uses, but defined here in corti so the
provider can be constructed from :class:`corti.config.LLMSettings`
