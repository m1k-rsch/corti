...
Mirrors :mod:`corti.service._session_lock` (and
:class:`corti.core.persistence.markdown.writer.MarkdownWriter`'s
...
Cross-process safety is out of scope: corti is single-process by
