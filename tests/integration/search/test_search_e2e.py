...
``test_filter_dsl_compiles_and_excludes``     filters DSL → Postgres ``where``
============================================  =================================
...
async def test_unknown_owner_returns_empty_200(
    ...
    # agent_cases and agent_skills removed from project
...
async def test_filter_dsl_compiles_and_excludes(
    ...
    # compiled and shipped to Postgres without breaking recall.
