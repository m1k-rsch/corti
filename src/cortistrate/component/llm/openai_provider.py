"""OpenAI-compatible LLM provider for cortistrate.
...
``OpenAICompatClient`` uses, but defined here in cortistrate so the
provider can be constructed from :class:`cortistrate.config.LLMSettings`
