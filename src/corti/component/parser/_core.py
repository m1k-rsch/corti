...
``everalgo-parser`` is an optional dependency (``corti[multimodal]``).
...
from corti.core.errors import MultimodalNotEnabledError, UnsupportedModalityError
...
async def aparse_file(raw_file: RawFile) -> ParsedContent:
    ...
    """
    from corti.component.llm import get_multimodal_llm_client
    from corti.core.errors import LLMServiceError
