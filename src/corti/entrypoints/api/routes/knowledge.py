...
if TYPE_CHECKING:
    from corti.service.knowledge import KnowledgeExtractor
...
async def _parse_upload(
    ...
    """
    from corti.component.parser import parser_available  # Deferred: optional dep

    if raw_bytes is None:
        raw_bytes = await file.read()

    if parser_available():
        from corti.component.parser import aparse_file  # Deferred: optional dep
    ...
    try:
        ...
        raise UnsupportedModalityError(
            ...
            "Install corti[multimodal] for PDF/HTML/DOCX support."
        ) from exc
