...
_INSTALL_HINT = (
    ...
    "Install it with:  pip install 'cortistrate[multimodal]'  "
    "(or  uv add 'cortistrate[multimodal]')."
)
...
def multimodal_available() -> bool:
    ...
    from cortistrate.component.parser import parser_available  # Deferred: optional dep probe
