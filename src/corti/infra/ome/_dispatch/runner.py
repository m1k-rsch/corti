...
from corti.infra.ome.decorator import StrategyMeta
from corti.infra.ome.events import BaseEvent
from corti.infra.ome.exceptions import EmitNotDeclaredError, StrategyContractError
from corti.infra.ome.records import RunRecord
...
class _RunCtx:
    """Implements :class:`~corti.infra.ome.context.StrategyContext` Protocol.
