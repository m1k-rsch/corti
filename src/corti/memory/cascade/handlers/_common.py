...
:func:`corti.core.persistence.markdown.entries._render_value` —
...
from corti.core.persistence import app_id_from_dir, project_id_from_dir
...
def resolve_scope(md_path: str) -> tuple[str, str]:
    ...
    ``"default"`` id (see :func:`corti.core.persistence.app_id_from_dir`).
...
def parse_inline_list(raw: str) -> list[str]:
    ...
    Mirrors :func:`corti.core.persistence.markdown.entries._render_value`
