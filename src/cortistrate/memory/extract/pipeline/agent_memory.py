...
Consumes pre-cut cells from :mod:`cortistrate.service._boundary` and emits
:class:`AgentPipelineStarted` per cell so the OME handles agent-specific
...
from cortistrate.memory import IngestResult, PipelineOutcome
