...
from cortistrate.infra.persistence.sqlite import QueueSummary, md_change_state_repo
...
class CascadeConfig:
    ...
    :class:`cortistrate.config.Settings` once the daemon has wall-clock data.
    """
