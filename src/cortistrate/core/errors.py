"""Cross-cutting exception hierarchy for Cortistrate.
...
class AppError(Exception):
    """Root for all Cortistrate application exceptions."""
...
class MultimodalNotEnabledError(CapabilityError):
    ...
    Raised when the ``cortistrate[multimodal]`` extra is not installed, or when
