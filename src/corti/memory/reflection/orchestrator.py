...
See ``local/2026-06-14-reflection-corti-design.md`` for the full design.
"""
...
from corti.component.utils.datetime import from_timestamp, to_iso_format
from corti.core.errors import AppError
...
class ReflectionOrchestrator:
    ...
    async def _create_reflection_report(
        ...
        *,
        ...
        from corti.infra.persistence.sqlite import ReflectionReport
