...
The structural contract every cortistrate LLM provider satisfies is the same
:class:`everalgo.llm.LLMClient` Protocol — cortistrate providers must be
...
stable (``cortistrate.component.llm``) even if the everalgo namespace
shifts later.
