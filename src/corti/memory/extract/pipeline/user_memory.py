...
:mod:`corti.service._boundary` (which also writes the single
...
from corti.memory import Episode, IngestResult, PipelineOutcome
...
def _episode_to_entry_body(
    ...
    because it depends on :class:`corti.memory.Episode` — infra is not
