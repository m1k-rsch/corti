"""Profile recall — KV-by-owner PG fetch (no ranking).
...
from cortistrate.infra.persistence.pg import user_profile_repo
...
class PgProfileRecaller:
    """Fetch the owner's profile row from PG, return at most one item."""
