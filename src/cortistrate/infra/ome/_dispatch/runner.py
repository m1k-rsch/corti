...
from cortistrate.infra.ome.decorator import StrategyMeta
from cortistrate.infra.ome.events import BaseEvent
from cortistrate.infra.ome.exceptions import EmitNotDeclaredError, StrategyContractError
from cortistrate.infra.ome.records import RunRecord
...
class _RunCtx:
    """Implements :class:`~cortistrate.infra.ome.context.StrategyContext` Protocol.
