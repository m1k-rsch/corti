...
from cortistrate.infra.ome.config import StrategyOverride, TomlRoot
from cortistrate.infra.ome.decorator import StrategyMeta
from cortistrate.infra.ome.gates import Counter
from cortistrate.infra.ome.triggers import Cron, Idle, Trigger
    ...
    def start(self) -> None:
        ...
        if not self._path.exists():
            raise FileNotFoundError(
                ...
                "Run `cortistrate init` to create configuration files."
            )
