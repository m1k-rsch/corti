...
from cortistrate.core.persistence.markdown import ProfilePathMixin, UserScopedFrontmatter
...
class UserProfileFrontmatter(ProfilePathMixin, UserScopedFrontmatter):
    ...
    :attr:`cortistrate.infra.persistence.sqlite.Cluster.last_ts_ms` to decide
