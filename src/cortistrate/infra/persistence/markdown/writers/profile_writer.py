...
in the Cortistrate Markdown First spec). Each profile lives at a fixed
...
from cortistrate.core.persistence import BaseFrontmatter, MarkdownWriter, MemoryRoot
