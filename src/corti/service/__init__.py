...
External usage:
    from corti.service import MemorizeResult, get, memorize, search
...
from corti.core.errors import DocumentNotFoundError as DocumentNotFoundError
from corti.core.errors import DuplicateDocumentError as DuplicateDocumentError
from corti.core.errors import ExtractionEmptyError as ExtractionEmptyError
from corti.core.errors import TopicNotFoundError as TopicNotFoundError
