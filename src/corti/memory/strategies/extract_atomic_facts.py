...
from corti.infra.persistence.markdown import AtomicFactWriter
from corti.memory.events import EpisodeExtracted
from corti.memory.models import AtomicFact
...
def _atomic_fact_to_entry_body(
    ...
    because it depends on :class:`corti.memory.AtomicFact` — infra is
