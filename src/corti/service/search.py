...
Mirrors the lazy-build pattern in :mod:`corti.service.memorize`: the
...
from corti.memory.search import SearchRequest, SearchResponse
...
if TYPE_CHECKING:
    ...
    from corti.component.llm import LLMClient
...
def _get_reranker() -> RerankProvider | None:
    ...
    from corti.component.rerank import build_rerank_provider
    from corti.config import load_settings
