...
if TYPE_CHECKING:
    from cortistrate.service.knowledge import KnowledgeExtractor
...
from cortistrate.entrypoints.api.utils import extract_request_id
...
async def _parse_upload(
    ...
    """
    from cortistrate.component.parser import parser_available  # Deferred: optional dep
    ...
    if parser_available():
        ...
        from cortistrate.component.parser import aparse_file  # Deferred: optional dep
    ...
    try:
        ...
        raise UnsupportedModalityError(
            ...
            "Install cortistrate[multimodal] for PDF/HTML/DOCX support."
        ) from exc
